...
class TestScoring(unittest.TestCase):
    ...
    def testScoreEmptyCups(self):
        ...
        self.assertEqual(self.board.NCUPS * 2, self.player2.score(self.board))
        self.assertEqual(self.board.NCUPS * -2, self.player1.score(self.board))
        self.board.P1Cups = [2] * self.board.NCUPS
        self.assertEqual(self.board.NCUPS * 3, self.player2.score(self.board))
        self.assertEqual(self.board.NCUPS * -3, self.player1.score(self.board))
        self.board.P1Cups = [0, 1, 0, 1, 0, 1]
        self.assertEqual(6, self.player2.score(self.board))